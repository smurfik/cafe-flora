...
[ ] - added /new view, associated routes & menu_section_controller method(s)
...
[ ] - added form for new menu section
    [ ] - included InvalidAuthenticityToken error workaround in new.html.erb
    [ ] - 'add' method in m_s controller
    ...
    [ ] - deleted @menu_item from 'show' in m_s controller (it forced a query on db for params that didn't exist)
