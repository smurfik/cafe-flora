...
[ ] - added form for new menu ITEM
  [ ] - included InvalidAuthenticityToken error workaround in show.html.erb
  [ ] - 'add' method in m_i controller
          - used 'raise' before method, then entered params in IRB, to confirm
            that the 'name' tag for the input (key) is associated with the
            actual input (value).
  [ ] - validation for this form
        [ ] - add 'validates' and arguments to model
        [ ] - add error message prompting input of missing info
